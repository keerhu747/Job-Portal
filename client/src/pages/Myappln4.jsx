...
export default function Myappln4() {
      ...
      <div className="max-w-6xl mx-auto px-8 py-8">
        ...
        <div className="flex justify-between items-center border-b border-gray-300 pb-4 mb-6">
          <div className="flex gap-3">
            ...
            <FilterBtn text="In review" active />
            <button
        ...
        {/* JOB ROW - CAB DRIVER ONLY */}
        <div className="grid grid-cols-12 items-center px-2 py-4">

          {/* LEFT SIDE */}
          <div className="col-span-6 flex items-start gap-4">
            <div className="w-14 h-12 bg-blue-100 rounded flex items-center justify-center">
              <Car size={18} className="text-blue-700" />
            </div>

            <div>
              <p className="font-medium">Cab Driver</p>
              <p className="text-sm text-gray-500">
                Uber • On-site • Australia
              </p>
            </div>
          </div>
